...
=======
# Generated by Django 4.2.11 on 2025-02-08 14:52
>>>>>>> 21abf36a0d109f21b2884062e1c79530bdbc678b
...
=======
        ...
        migrations.CreateModel(
            name='SubUnitMaster',
            fields=[
                ('sum_id', models.AutoField(help_text='Primary Key (Auto-incremented for Sub Unit)', primary_key=True, serialize=False)),
                ('sum_unitname', models.CharField(help_text='Name of the Sub Unit', max_length=50)),
                ('sum_unitsales', models.CharField(help_text='Sales associated with the Sub Unit', max_length=50)),
                ('sum_unitdelivery', models.CharField(help_text='Delivery associated with the Sub Unit', max_length=50)),
                ('sum_unitsolution', models.CharField(help_text='Solution associated with the Sub Unit', max_length=50)),
                ('sum_isaative', models.BooleanField(default=True, help_text='Indicates if the Sub Unit is currently active')),
                ('sum_insertdate', models.DateTimeField(default=django.utils.timezone.now, help_text='Timestamp when the Sub Unit record was created')),
                ('sum_updatedate', models.DateTimeField(default=django.utils.timezone.now, help_text='Timestamp when the Sub Unit record was last updated')),
                ('sum_deliverymanager', models.ForeignKey(blank=True, help_text='Delivery Manager from Employee Master', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='subunit_delivery_manager', to='hiringManagementTool.employeemaster')),
                ('sum_insertby', models.ForeignKey(blank=True, help_text='Reference to the employee who inserted this record', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='subunit_inserted_records', to='hiringManagementTool.employeemaster')),
                ('sum_sbu_id', models.ForeignKey(help_text='Strategic Business Unit (SBU) associated with the Sub Unit', on_delete=django.db.models.deletion.CASCADE, related_name='subunits', to='hiringManagementTool.strategicbusinessunitmaster')),
                ('sum_spoc', models.ForeignKey(blank=True, help_text='Single Point of Contact (SPOC) from Employee Master', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='subunit_spoc', to='hiringManagementTool.employeemaster')),
                ('sum_updateby', models.ForeignKey(blank=True, help_text='Reference to the employee who last updated this record', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='subunit_updated_records', to='hiringManagementTool.employeemaster')),
            ],
>>>>>>> 21abf36a0d109f21b2884062e1c79530bdbc678b
        ),
        migrations.CreateModel(
...
=======
                ('dem_dsm', models.ForeignKey(help_text='Reference to Sub Unit Master Table', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='dsm_demands', to='hiringManagementTool.subunitmaster')),
                ('dem_insertby', models.ForeignKey(help_text='User ID (Employee) who inserted this record', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='demands_inserted', to='hiringManagementTool.employeemaster')),
                ('dem_lcm', models.ForeignKey(help_text='Reference to Location Master Table', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='location_demands', to='hiringManagementTool.locationmaster')),
                ('dem_lob', models.ForeignKey(help_text='Reference to LOB Master Table', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='lob_demands', to='hiringManagementTool.lobmaster')),
                ('dem_sub', models.ForeignKey(help_text='Reference to Sub Unit Master Table', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='subunit_demands', to='hiringManagementTool.subunitmaster')),
                ('dem_updateby', models.ForeignKey(help_text='User ID (Employee) who last updated this record', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='demands_updated', to='hiringManagementTool.employeemaster')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('dsm_updatedate', models.DateTimeField(auto_now=True, help_text='Record Last Updated Timestamp')),
                ('dsm_isclosed', models.BooleanField(default=False, help_text='Indicates if the status is treated as closed')),
                ('dsm_insertedby', models.ForeignKey(help_text='User ID (Employee) who created this status', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='status_inserted', to='hiringManagementTool.employeemaster')),
                ('dsm_updateby', models.ForeignKey(help_text='User ID (Employee) who last updated this status', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='status_updated', to='hiringManagementTool.employeemaster')),
            ],
>>>>>>> 21abf36a0d109f21b2884062e1c79530bdbc678b
        ),
        migrations.CreateModel(
