...
from hiringManagementTool.components.candidates.views import CandidateAPIView, CandidateDetailAPIView, CandidateStatusUpdateAPIView, CandidateHistoryAPIView, AllCandidateAPIView
